...
pub fn main() !u8 {
...

    {
        ...
        switch (output_format) {
            ...
            .svg => {
                try renderSvg(allocator, std.io.FixedBufferStream([]u8).Reader, output_stream.writer(), &parser);
            },
        }
    }
    return 0;
...
fn renderSvg(allocator: std.mem.Allocator, comptime Reader: type, writer: anytype, parser: *tvg.parsing.Parser(Reader)) !void {
